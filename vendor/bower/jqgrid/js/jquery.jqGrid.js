...
$.fn.jqGrid = function( pin ) {
	...
	return this.each( function() {
		...
		setPager = function (pgid, tp){
			...
			if(ts.p.pgbuttons===true) {
				/*
					Modify to use GYLPHICON by Chinnawat.B (#BOMBERMAN, #BOMCPE11)
				*/
				var po=["first"+tp,"prev"+tp, "next"+tp,"last"+tp]; if(dir==="rtl") { po.reverse(); }
				pgl += "<td id='"+po[0]+"' class='ui-pg-button ui-corner-all'><span class='glyphicon glyphicon-step-backward'></span></td>";
				pgl += "<td id='"+po[1]+"' class='ui-pg-button ui-corner-all'><span class='glyphicon glyphicon-backward'></span></td>";
				pgl += pginp !== "" ? sep+pginp+sep:"";
				pgl += "<td id='"+po[2]+"' class='ui-pg-button ui-corner-all'><span class='glyphicon glyphicon-forward'></span></td>";
				pgl += "<td id='"+po[3]+"' class='ui-pg-button ui-corner-all'><span class='glyphicon glyphicon-step-forward'></span></td>";
	...
	navGrid : function (elem, o, pEdit,pAdd,pDel,pSearch, pView) {
		...
		*/
		o = $.extend({
			...
			del: true,
			delicon:"glyphicon-trash",//"ui-icon-trash",
			search: false,
			searchicon:"glyphicon-search",//"ui-icon-search",
			refresh: true,
			refreshicon:"glyphicon-refresh",//"ui-icon-refresh",
		...
		return this.each(function() {
			...
			for(i = 0; i<clone; i++) {
				...
				if (o.add) {
					...
					$(tbd).append("<div class='ui-pg-div'><span class='glyphicon "+o.addicon+"'></span>"+o.addtext+"</div>");
				...
				if (o.del) {
					tbd = $("<td class='ui-pg-button ui-corner-all'></td>");
					pDel = pDel || {};
					$(tbd).append("<div class='ui-pg-div'><span class='glyphicon "+o.delicon+"'></span>"+o.deltext+"</div>");
					$("tr",navtbl).append(tbd);
					$(tbd,navtbl)
				...
				if (o.search) {
					tbd = $("<td class='ui-pg-button ui-corner-all'></td>");
					pSearch = pSearch || {};
					$(tbd).append("<div class='ui-pg-div'><span class='glyphicon "+o.searchicon+"'></span>"+o.searchtext+"</div>");
					$("tr",navtbl).append(tbd);
					$(tbd,navtbl)
				...
				if (o.refresh) {
					tbd = $("<td class='ui-pg-button ui-corner-all'></td>");
					$(tbd).append("<div class='ui-pg-div'><span class='glyphicon "+o.refreshicon+"'></span>"+o.refreshtext+"</div>");
					$("tr",navtbl).append(tbd);
					$(tbd,navtbl)
		...
		return this.each(function() {
			...
			if (findnav) {
				...
				if(p.buttonicon.toString().toUpperCase() === "NONE") {
					...
					$(tbd).addClass('ui-pg-button ui-corner-all').append("<div class='ui-pg-div'><span class='glyphicon "+p.buttonicon+"'></span>"+p.caption+"</div>");
				}
				$(tbd).addClass(p.addClass);
...
//Editing
	...
	inlineNav : function (elem, o) {
		o = $.extend(true,{
			...
			addicon:"glyphicon-plus",
			save: true,
			saveicon:"glyphicon-floppy-disk",
			cancel: true,
			...
			if(o.add) {
				$($t).jqGrid('navButtonAdd', elem,{
					...
					onClickButton : function () {
						if(o.onbeforeaddfunc()===undefined){
